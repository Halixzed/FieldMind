"""
FieldMind Backend — Production v2.0
...
log = logging.getLogger("fieldmind")
...
app = FastAPI(title="FieldMind API", version="2.0.0", docs_url="/docs")
...
SYSTEM_PROMPT = """You are FieldMind, an expert agricultural AI assistant running entirely on-device on a local compute board installed at a UK allotment. You have access to real-time soil sensor data and weather forecasts.
